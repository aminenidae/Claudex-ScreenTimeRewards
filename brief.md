...
- **Target Platforms:** Universal iOS/iPadOS app (parent & child modes)
- **OS Support:** iOS/iPadOS 16.0+ (Screen Time APIs requirement)
- **Performance Requirements:** <5% battery impact (mobile), <100MB storage

- ### Technology Preferences

- **Frontend:** SwiftUI-first for iOS/iPadOS; UIKit where needed
...
- **Frameworks:** Use Apple’s Screen Time APIs (iOS/iPadOS 16+): `FamilyControls`, `ManagedSettings`, and `DeviceActivity`.
