...
- **App Inventory Sync:** Provide a one-tap child flow to capture display names/icons for selected tokens so Parent Mode immediately shows recognisable app labels. **Status: Open 🚧**
